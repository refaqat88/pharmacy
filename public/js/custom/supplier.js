$(document).ready(function () {
    ...
    $('#add-kata-btn').click(function (e) {
        ...
        $('#kata-modal form').attr('action',base_url +"supplier-katas/create");
    ...
    $(document).on("click", ".show-katas", function (e) {
        ...
        var $this = $(this);
        var id = $this.data('id');
        var url = base_url + "supplier-katas/show";
    ...
    $(document).on("click", ".edit-katas", function (e) {
        ...
        $('#kata-form').attr('action',base_url +"supplier-katas/update");
        $('#kata-modal').modal('show');
        ajaxSetting();
        $.ajax({
            url: base_url + "supplier-katas/edit/",
            method: 'get',
            dataType: "json",
            data: {id: id},
            success: function (result) {
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: base_url + 'supplier-katas/delete',
                        method: 'get',
                        dataType: "json",
                        data: {
                            id: id,
