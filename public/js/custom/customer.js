$(document).ready(function () {
    ...
    $(document).on('click keyup mouseup','.productrow', function () {
       ...
       var item_price_retail=$this.data('item_price_retail');
       var id = $this.data('id');
       ...
       var supplier_price = $("#bill-row_"+row).find('.item_unit_price').val(item_price_retail);
        $("#bill-row_"+row).find('.item_unit_price').val(item_price_retail);
...
$(document).on('click','.delete-product-row', function () {
    ...
    $(document).on("blur keyup", ".mobile-number", function (e) {
        ...
        var url = base_url + "customer/bill/mobile";
        ajaxSetting();
        $.ajax({
            url: url,
            method: 'post',
    ...
    $(document).on("click", ".show-bill", function (e) {
        ...
        var $this = $(this);
        var id = $this.data('id');
        var url = base_url + "customer/bill/show";
