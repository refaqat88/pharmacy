$(document).ready(function () {
    ...
    function htmlApeend(){
        ...
        var html = `<tr class="table-row" id="bill-row_${rowCount}">
                        ...
                        <td class=""><input class="form-control item_unit_price" readonly name="item_unit_price[]" required type="number" min="1" max="1000000"/></td>
            ...
            success: function (result) {
                ...
                $.each(result.bill_info, function (key, value) {
                    ...
                    $('#show-Bill-datatable tbody').append(`<tr class="table-row">
                                        ...
                                        <td class="">${value.product} (${value.quantity} ✕ ${value.packet_per_box} ✕ ${value.item_per_packet} ✕ ${value.item_price_supplier})</td>
