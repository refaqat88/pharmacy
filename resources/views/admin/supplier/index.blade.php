...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ">
                        ...
                        <div class="row">
                            <h4 class="card-title col-md-6 mr-0">Supplier Khata's</h4>
                            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="card-title">Supplier Khata's Record List</h6>
                                </div>
                                <div class="card-body">
                                    <table id="datatable" data-id="datatable" class="table table-hover custom_border" cellspacing="0" width="100%">
                                        ...
                                        @foreach ($allusers as $key => $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->kata?$user->kata->paid_date:0 }}</td>
                                                <td>{{ $user->kata?$user->kata->page_no:'' }}</td>
    ...
    <div class="modal fade" id="kata-modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-sm">
            <form id="kata-form" action="{{url('supplier-katas/create')}}" enctype="multipart/form-data" method="Post">
                @csrf
                        ...
                        <div class="col-sm-12" id="form_add">
                            <div class="row">
                                ...
                                <div class="form-group total_amount col-sm-4">
                                    ...
                                    <input class="form-control calculate" value="0" name="total_amount" id="total_amount"type="number" min="0" max="10000000"/>

                                </div>

                                <div class="form-group paid_amount col-sm-4">
                                    <label>Paid Amount</label>
                                    <input class="form-control calculate" value="0" name="paid_amount" id="paid_amount" type="number" min="-10000000" max="10000000"/>
