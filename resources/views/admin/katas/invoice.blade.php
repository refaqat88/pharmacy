@extends('layouts.app')
@section('title', 'Temporary Khata\'s Invoice')
@section('content')
                    ...
                    <div class="col-12 col-lg-12" id="Invoice">
                        <div class="row">
                            ...
                            <div class="col-8 text-150 pt-25">
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Address:</span> {{Auth::user()->address}}</div>

                                    <div class="my-2"><i class="text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Phone:</span> {{Auth::user()->phone}}</div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="text-grey-m2">
                                    <div class="my-1">
                                        <i class="fa fa-address-card fa-flip-horizontal text-secondary"></i> <b class="text-600">{{$user->kata?$user->kata->address:''}}</b>
                                    </div>
                            ...
                            <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">ID:</span> #{{$user->kata?$user->kata->receipt_no:''}}</div>

                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Issue Date:</span> {{$user->kata?$user->kata->paid_date:''}}</div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-95 text-secondary-d3">
                                <div class="row mb-2 mb-sm-0 py-10">
                                    ...
                                    <div class="col-2 col-sm-2">{{$user->kata?$user->kata->total_amount:''}}</div>
                                    <div class="d-none d-sm-block col-2">{{$user->kata?$user->kata->paid_amount:''}}</div>
                                    <div class="d-none d-sm-block col-2 text-95">{{$user->kata?$user->kata->remaining_amount:''}}</div>
                                    <div class="d-none d-sm-block col-2 text-95">{{$user->kata?$user->kata->paid_date:''}}</div>
                                    <div class="col-2 text-secondary-d2">{{$user->kata?$user->kata->amount_status:''}}</div>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                    ...
                                    <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                        ...
                                        <div class="col-5">
                                            <span class="text-150 text-success-d3 opacity-2">Rs {{$user->kata?$user->kata->remaining_amount:''}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
