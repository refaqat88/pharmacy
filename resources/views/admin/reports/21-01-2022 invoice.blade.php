                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row pb-5 p-5">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1">{{$khata->user?$khata->user->name:''}}</p>
                                    <p>{{$khata->address}}</p>
                                    <p class="mb-1">{{$khata->user?$khata->user->phone:''}}</p>
                                    <p class="mb-1">@php
                                       if($khata->type==0){
                                        echo 'Temporary';
                                        }if($khata->type==1){
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <p class="mb-1"><span class="text-muted">Invoice: </span> Invoice #{{$khata->receipt_no}}</p>
                            ...
                            <div class="row p-5">
                                <div class="col-md-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td>{{$khata->total_amount}}</td>
                                            <td>{{$khata->paid_amount}}</td>
                                            <td>{{$khata->remaining_amount}}</td>
                                            <td>{{$khata->paid_date}}</td>
                                            <td>{{$khata->amount_status}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="d-flex flex-row-reverse  p-4">
                                ...
                                <div class="py-3 px-5 text-right">
                                    ...
                                    <div class="font-weight-light">Rs {{$khata->remaining_amount}}</div>
                                </div>
