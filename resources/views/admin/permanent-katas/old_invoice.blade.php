@extends('layouts.app')
@section('title', 'Permanent Katas Invoice')
@section('content')
    ...
    <div class="content" id="content">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <button class="btm btn-secondary float-right export">Print</button>
                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row pb-5 p-5">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1">{{$user->kata?$user->kata->address:''}}</p>
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <p class="mb-1"><span class="text-muted">Invoice: </span> {{$user->kata?$user->kata->receipt_no:''}}</p>
                            ...
                            <div class="d-flex flex-row-reverse  p-4">
                                ...
                                {{--<div class="py-3 px-5 text-right">
                                    ...
                                    <div class="h2 font-weight-light">Rs {{$user->permanentKata?$user->permanentKata->paid_amount:''}}</div>
                                </div>
                                ...
                                <div class="py-3 px-5 text-right">
                                    ...
                                    <div class="h2 font-weight-light">Rs {{$user->permanentKata?$user->permanentKata->total_amount:''}}</div>
                                </div>--}}
